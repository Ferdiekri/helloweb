<%@include file="../includes/header.jsp" %>
		...
		<h1>ejercicios de Bootstrap 4</h1>
		<hr>
		...
		<nav>
			<ol>
				<li><h2>Capítulo 1. Introducción</h2>
					<ol>
						<li>1.1. <a href="ejemplos-bootstrap/ejemplo-inicial.jsp?title=Ejemplo%20Jinicial">Ejemplo inicial</a></li>
						<li>1.2. <a href="ejemplos-bootstrap/ejemplo-componentes.jsp?title=Componentes">Componentes</a></li>
